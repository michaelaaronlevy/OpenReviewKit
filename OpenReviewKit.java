...
/**
 * The main class for the Open Review Kit (ORK) Project GUI. There can be only
 * one instance of OpenReviewKit. This object has a JFrame that can show the
 * text extractor GUI (to select files to process, the processing mode, and the
 * output file) or it can show any arbitrary JComponent (for example, the
...
public class OpenReviewKit
{
   ...
   public static final String _ORK_VERSION = "1.0.0";
   ...
   public static final String _ORK_TITLE = _ORK_LONG_NAME
         + " - Michael Levy, Civil Rights Lawyer - michael@levycivilrights.com";

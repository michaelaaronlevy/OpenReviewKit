 ...
 * 
 * <p>This relies on the {@link ExtractionMode ExtractionMode} interface.
 * 
 * <p>(drag and drop support is thanks to {@link com.github.michaelaaronlevy.ork.util.FileDrop FileDrop} by Robert Harder)
 * 
      ...
      public void actionPerformed(final ActionEvent aev)
      {
         ...
         else if(source == runButton)
         {
            ...
            else
            {
               ...
               try
               {
                  ripper = new PdfToTextGrid(files, m.getParser(), m.getTransformer(), m.getConsumer(targetOut), m, false);
               }
